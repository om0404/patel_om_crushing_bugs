...
function changeBGImage() {
	...
	// removeChild(dropZones)
	// puzzleBoard.find('.drop-zone').children('img').remove();
	// puzzleBoard.querySelector('.drop-zone img').remove();
	// puzzleBoard.innerHTML = '';
	// document.querySelector('.game-b img').style.display='block'
	// puzzlePieces.style.display = 'block'
